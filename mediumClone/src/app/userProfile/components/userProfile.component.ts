...
@Component({
    ...
    standalone: true, 
    imports: [CommonModule, RouterLink, RouterLinkActive, FeedComponent, FollowButtonComponent]
})
export class UserProfileComponent implements OnInit{
    ...
    isCurrentUserProfile$ = combineLatest(
        ...
        map(
            ([currentUser, userProfile]:[CurrentUserInterface|null, UserProfileInterface]) => {
