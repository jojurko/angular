...
export const registerEffect = createEffect(
  ...
  export const redirectAfterRegisterEffect = createEffect(
    (actions$ = inject(Actions), router=inject(Router)) => {
      return actions$.pipe(
        ...
        tap(()=>{  //side effect, redirectni sa na pagu
          router.navigateByUrl('/')
        })
      )
    },{
      functional: true, dispatch:false //dispatch, nic negeneruje, len redirectujem...
    }
  )
  ...
  export const loginAfterRegisterEffect = createEffect(
    (actions$ = inject(Actions), router=inject(Router)) => {
      return actions$.pipe(
